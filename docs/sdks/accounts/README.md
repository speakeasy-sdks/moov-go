...
func main() {
    ...
    accountID := "13b99d48-8e1e-491e-850a-d2abd4426980"
...
func main() {
    ...
    res, err := s.Accounts.List(ctx, operations.ListAccountsRequest{
        Count: moovgo.Int64(164940),
        Email: moovgo.String("Friedrich67@hotmail.com"),
        ForeignID: moovgo.String("4528aba-b9a1-11eb-8529-0242ac13003"),
        IncludeDisconnected: moovgo.Bool(false),
        Name: moovgo.String("Eddie Prosacco"),
        Skip: moovgo.Int64(962189),
...
func main() {
    ...
    accountID := "3c969e9a-3efa-477d-bb14-cd66ae395efb"
...
func main() {
    ...
    accountID := "a88f3a66-9970-474b-a446-9b6e21419598"
