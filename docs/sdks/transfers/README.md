...
func main() {
    ...
    transferID := "03fa7112-315a-4072-a9f2-43f3f1ec962e"
...
func main() {
    ...
    createTransfer := shared.CreateTransfer{
        ...
        FacilitatorFee: &shared.CreateFacilitatorFee{
            Markup: moovgo.Int64(486589),
            Total: moovgo.Int64(489382),
        },
        ...
        Source: &shared.CreateTransferSource{
            ...
            CardDetails: &shared.CreateCardDetails{
                ...
                TransactionSource: shared.TransactionSourceFirstRecurring.ToPointer(),
            },
            PaymentMethodID: moovgo.String("ec7e1848-dc80-4ab0-8827-dd7fc0737b43"),
...
func main() {
    ...
    transferID := "b18d8d81-fd7b-4764-a31e-475cb1f36591"
    accountID := "58ccc65b-c928-4154-952e-30c048b8c2b5"
...
func main() {
    ...
    transferID := "dcb7cb00-9cc1-4b92-8e6f-29c9d50583d5"
...
func main() {
    ...
    transferID := "7fdf7d4f-a689-4415-8f2e-71877eebee60"
...
func main() {
    ...
    xIdempotencyKey := "ec7e1848-dc80-4ab0-8827-dd7fc0737b43"
    transferID := "94e35bc6-be02-470f-a21a-a226b055b594"
...
func main() {
    ...
    transferID := "5bf4aa77-f204-4e77-94c3-52acfe54077c"
    accountID := "abf6805c-5ca7-4187-9435-5ad7d4e1b584"
