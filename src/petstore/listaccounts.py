...
class ListAccounts:
    ...
    def get(self, request: operations.GetListAccountsRequest) -> operations.GetListAccountsResponse:
        r"""List accounts
        ...
        headers = {}
        query_params = utils.get_query_params(operations.GetListAccountsRequest, request)
        ...
        res = operations.GetListAccountsResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
