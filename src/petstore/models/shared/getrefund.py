...
class GetRefundFailureCode(str, Enum):
...
class GetRefund:
    ...
    failure_code: Optional[GetRefundFailureCode] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('failureCode'), 'exclude': lambda f: f is None }})
    r"""This field is deprecated and will be removed in December 2023.
