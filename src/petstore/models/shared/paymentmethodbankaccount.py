...
class PaymentMethodBankAccountBankAccount:
...
class PaymentMethodBankAccount:
    ...
    bank_account: Optional[PaymentMethodBankAccountBankAccount] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('bankAccount'), 'exclude': lambda f: f is None }})
